...
class GraphVisualizer:
    ...
    def draw(graph: Graph):
        ...
        for i, (x, y) in positions.items():
            ...
            ax.text(x, y, str(i), fontsize=12, ha='center', va='center', zorder=4, color='white', bbox=dict(facecolor='black', edgecolor='black', boxstyle='circle'))
    ...
    def draw_natural(graph: Graph):
        ...
        pos = nx.spring_layout(G)  # Algorytm układu sprężynowego dla naturalnej wizualizacji
